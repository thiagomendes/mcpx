pub mod error {
    ...
    pub const INVALID_SERVER_ID: &str = "Invalid server ID";
    ...
    pub const FAILED_TO_FETCH_USER_INFO: &str = "Failed to fetch user info";
    pub const FAILED_TO_PARSE_USER_INFO: &str = "Failed to parse user info";
    pub const FAILED_TO_BUILD_RESPONSE: &str = "Failed to build response";
    ...
    pub const TOOL_NOT_ALLOWED: &str = "is not allowed by governance policy";
    ...
    pub const OAUTH_NOT_CONFIGURED: &str = "OAuth not configured for this server";
    pub const OAUTH_CALLBACK_FAILED: &str = "OAuth callback failed";
    pub const ENCRYPTION_ERROR: &str = "Encryption error";
    pub const FAILED_TO_READ_RESPONSE: &str = "Failed to read response";
