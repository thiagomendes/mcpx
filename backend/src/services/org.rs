    ...
    async fn init_default_settings(pool: &PgPool, org_id: Uuid) -> Result<(), sqlx::Error> {
        let settings = vec![
            (
                ...
                "30",
                "integer",
                "How long user login sessions last before requiring re-authentication.",
            ),
            (
                "m2m_token_expiry_hours",
                "1",
                "integer",
                "How long Service Account (M2M) tokens are valid.",
            ),
            (
                "max_servers_per_org",
                "100",
                "integer",
                "Maximum number of MCP servers allowed per organization.",
            ),
            (
                "max_gateways_per_org",
                "50",
                "integer",
                "Maximum number of gateways allowed per organization.",
            ),
            (
                "max_pats_per_user",
                "10",
            ...
            (
                ...
                "20",
                "integer",
                "Maximum service accounts per organization.",
            ),
        ];
